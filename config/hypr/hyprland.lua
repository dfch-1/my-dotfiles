...
hl.bind(mainMod .. " + CTRL + Return", hl.dsp.exec_cmd(terminal .. " -e btop"))
...
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd(browser .. " https://github.com/"))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd(browser .. " https://translate.google.com/"))
...
hl.bind(mainMod .. " + CTRL + ESCAPE", hl.dsp.exec_cmd("reboot"))
hl.bind(mainMod .. " + CTRL + V", hl.dsp.exec_cmd("vlc"))
